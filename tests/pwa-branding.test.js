...
assert.match(serviceWorker, /simplificando-cifras-v61/);
assert.match(serviceWorker, /event-collaboration-client\.js\?v=2/);
assert.match(serviceWorker, /js\/ai\/harmonic-summary-client\.js/);
assert.match(serviceWorker, /js\/editor\/song-editor\.js/);
assert.match(indexHtml, /js\/editor\/song-format\.js\?v=4/);
assert.match(serviceWorker, /js\/editor\/song-format\.js\?v=4/);
assert.match(indexHtml, /js\/song-model\.js\?v=3/);
assert.match(serviceWorker, /js\/song-model\.js\?v=3/);
assert.match(indexHtml, /js\/ai\/harmonic-summary-client\.js\?v=2/);
assert.match(serviceWorker, /js\/ai\/harmonic-summary-client\.js\?v=2/);
...
assert.match(serviceWorker, /js\/spotify-config\.js\?v=3/);
assert.match(serviceWorker, /js\/spotify-api\.js\?v=3/);
assert.match(serviceWorker, /js\/spotify-ui\.js\?v=4/);
assert.match(indexHtml, /js\/spotify-config\.js\?v=3/);
assert.match(indexHtml, /js\/spotify-api\.js\?v=3/);
assert.match(indexHtml, /js\/spotify-ui\.js\?v=4/);
assert.match(serviceWorker, /js\/stage-preferences\.js\?v=1/);
