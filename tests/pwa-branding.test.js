...
assert.match(serviceWorker, /simplificando-cifras-v51/);
assert.match(serviceWorker, /js\/ai\/harmonic-summary-client\.js/);
assert.match(serviceWorker, /js\/editor\/song-editor\.js/);
assert.match(indexHtml, /js\/editor\/song-format\.js\?v=2/);
assert.match(serviceWorker, /js\/editor\/song-format\.js\?v=2/);
