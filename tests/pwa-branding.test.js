...
assert.match(serviceWorker, /simplificando-cifras-v70/);
...
assert.match(indexHtml, /js\/editor\/song-format\.js\?v=5/);
assert.match(serviceWorker, /js\/editor\/song-format\.js\?v=5/);
assert.match(indexHtml, /js\/song-model\.js\?v=4/);
assert.match(serviceWorker, /js\/song-model\.js\?v=4/);
assert.match(indexHtml, /js\/ai\/harmonic-summary-client\.js\?v=3/);
assert.match(serviceWorker, /js\/ai\/harmonic-summary-client\.js\?v=3/);
...
assert.match(serviceWorker, /js\/spotify-config\.js\?v=4/);
assert.match(serviceWorker, /js\/spotify-api\.js\?v=3/);
assert.match(serviceWorker, /js\/spotify-ui\.js\?v=4/);
assert.match(indexHtml, /js\/spotify-config\.js\?v=4/);
