...
assert.match(serviceWorker, /simplificando-cifras-v52/);
assert.match(serviceWorker, /js\/ai\/harmonic-summary-client\.js/);
assert.match(serviceWorker, /js\/editor\/song-editor\.js/);
assert.match(indexHtml, /js\/editor\/song-format\.js\?v=3/);
assert.match(serviceWorker, /js\/editor\/song-format\.js\?v=3/);
assert.match(indexHtml, /js\/song-model\.js\?v=2/);
assert.match(serviceWorker, /js\/song-model\.js\?v=2/);
