...
assert.match(serviceWorker, /simplificando-cifras-v128-demo-library/);
...
assert.match(serviceWorker, /js\/demo-library\.js\?v=1/);
assert.match(serviceWorker, /js\/song-repository\.js\?v=9/);
assert.match(serviceWorker, /js\/library-sync\.js\?v=13/);
