...
assert.match(serviceWorker, /simplificando-cifras-v71/);
...
assert.match(indexHtml, /js\/ai\/harmonic-summary-client\.js\?v=4/);
assert.match(serviceWorker, /js\/ai\/harmonic-summary-client\.js\?v=4/);
