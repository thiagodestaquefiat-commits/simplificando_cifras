...
assert.match(serviceWorker, /simplificando-cifras-v80-classification/);
...
assert.match(indexHtml, /js\/editor\/song-format\.js\?v=7/);
assert.match(serviceWorker, /js\/editor\/song-format\.js\?v=7/);
