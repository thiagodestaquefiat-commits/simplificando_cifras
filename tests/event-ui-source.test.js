...
assert.match(html, /id="event-chat-fab"[\s\S]*?id="event-notification-button"/);
assert.match(html, /event-chat-header-button\[hidden\]/);
assert.match(html, /changeEventOfficialKey/);
assert.match(html, /eventModel\.canEditShared\(event,actor\.id\)/);
...
assert.match(html, /openEventLeadershipTransfer/);
assert.match(html, /confirmEventLeadershipTransfer/);
assert.match(html, /eventCollaboration\.transferLeadership/);
assert.match(html, /event-leadership-action/);
assert.match(html, /Convidar Integrante/);
assert.match(html, /navigator\.share\(\{title:'Convite para '/);
assert.match(html, /acceptPendingEventInvitation/);
assert.doesNotMatch(html, /id="event-member-id"|name="event-leader-id"/);
