...
Estas propostas não fazem parte da estabilização atual e não foram implementadas.

- Extrair gradualmente estilos e comportamento embutidos no `index.html`, mantendo testes de regressão visual.
- Gerar ícones PNG de 192×192 e 512×512 a partir do logotipo aprovado para ampliar compatibilidade PWA.
- Criar um repositório de dados sincronizável, com migração versionada do armazenamento local para uma API.
- Implementar login, equipes, planos e sincronização somente após definição de backend e modelo de permissões.
