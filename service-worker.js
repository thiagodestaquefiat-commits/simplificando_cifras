const CACHE_NAME = "simplificando-cifras-v135-roudy-icon";
const ASSETS = [
  "./",
  "./index.html",
  "./js/storage.js",
  ...
  "./assets/icons/roudy-icon-v4-512.png?v=15",
  "./assets/icons/roudy-icon-v4-maskable-192.png?v=15",
  "./assets/icons/roudy-icon-v4-maskable-512.png?v=15"
];
