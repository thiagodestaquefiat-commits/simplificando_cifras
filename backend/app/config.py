...
class Config:
    ...
    ANTHROPIC_SEARCH_MAX_TOKENS = int(os.getenv("ANTHROPIC_SEARCH_MAX_TOKENS", "3500"))
    ANTHROPIC_NORMALIZE_MAX_TOKENS = int(os.getenv("ANTHROPIC_NORMALIZE_MAX_TOKENS", "2500"))
